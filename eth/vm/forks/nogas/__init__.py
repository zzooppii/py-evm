...
from eth.vm.base import FrontierVM
...
from .validation import validate_nogas_transaction_against_header
...
def make_nogas_receipt(base_header: BlockHeaderAPI,
...
class NogasVM(FrontierVM):
    # fork name
    fork: str = 'nogas'  # noqa: E701  # flake8 bug that's fixed in 3.6.0+

    # classes
    block_class: Type[BlockAPI] = NogasBlock
    ...
    validate_transaction_against_header = validate_nogas_transaction_against_header
    ...
    def make_receipt(
        ...
        receipt_without_state_root = make_nogas_receipt(base_header, transaction, computation)
